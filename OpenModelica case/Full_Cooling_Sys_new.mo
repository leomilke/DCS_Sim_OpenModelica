model Full_Cooling_Sys_new
  ...
  Modelica.Blocks.Sources.CombiTimeTable CB_Run_index(tableOnFile = true, tableName = "Index", fileName = "C:/Users/leomilke/Desktop/XXX/CB_run_index.txt", columns = {2}, smoothness = Modelica.Blocks.Types.Smoothness.ConstantSegments)  annotation(
    Placement(transformation(origin = {96, -152}, extent = {{10, -10}, {-10, 10}})));
...
equation
  ...
  connect(TimeSeriesData.y[3], P_Total.u2) annotation(
    Line(points = {{-38, -40}, {-22, -40}, {-22, -74}, {28, -74}, {28, -146}, {40, -146}, {40, -180}, {58, -180}}, color = {0, 0, 127}));
  ...
  connect(CB_Run_index.y[1], P_CB_Real.u1) annotation(
    Line(points = {{85, -152}, {56, -152}, {56, -132}, {18, -132}}, color = {0, 0, 127}));
  connect(P_CB_Real.y, P_C.u1) annotation(
    Line(points = {{12, -155}, {26, -155}, {26, -168}}, color = {0, 0, 127}));
  connect(CB_Run_index.y[1], m_flow_sum_CB_Real.u2) annotation(
    Line(points = {{85, -152}, {85, -8}, {136, -8}, {136, 4}}, color = {0, 0, 127}));
  annotation(
