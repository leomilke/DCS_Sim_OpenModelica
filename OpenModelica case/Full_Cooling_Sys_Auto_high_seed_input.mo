model Full_Cooling_Sys_Auto_high_seed_input
  ...
  Modelica.Blocks.Sources.CombiTimeTable TankCW_M_B(tableOnFile = true, tableName = "T", fileName = "C:/Users/leomilke/Desktop/XXX/CWTank_m_base.txt", columns = {2}, smoothness = Modelica.Blocks.Types.Smoothness.LinearSegments)  annotation(
    Placement(transformation(origin = {218, -188}, extent = {{10, -10}, {-10, 10}})));
  Modelica.Blocks.Math.Product P_CB_Real annotation(
    Placement(transformation(origin = {12, -144}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Blocks.Noise.UniformNoise uniformNoise(fixedLocalSeed = Seed_Random_Py, samplePeriod = 900, useAutomaticLocalSeed = false, useGlobalSeed = true, y_max = 50, y_min = 0, enableNoise = true) annotation(
  ...
  Modelica.Blocks.Discrete.Sampler sampler(samplePeriod = 600)  annotation(
    Placement(transformation(origin = {178, -188}, extent = {{10, -10}, {-10, 10}}, rotation = -0)));
  Modelica.Blocks.Discrete.Sampler sampler1(samplePeriod = 600) annotation(
    Placement(transformation(origin = {128, -186}, extent = {{-10, -10}, {10, 10}}, rotation = -0)));
...
equation
  ...
  connect(booleanToReal.u, CB_Run_index.y) annotation(
    Line(points = {{80, -230}, {97, -230}}, color = {255, 0, 255}));
  connect(P_CB_Real.u1, booleanToReal.y) annotation(
    Line(points = {{18, -132}, {46, -132}, {46, -230}, {57, -230}}, color = {0, 0, 127}));
  connect(m_flow_sum_CB_Real.u2, booleanToReal.y) annotation(
  ...
  connect(TankCW_M_B.y[1], sampler.u) annotation(
    Line(points = {{208, -188}, {190, -188}}, color = {0, 0, 127}));
  connect(sampler.y, CB_Run_index.u1) annotation(
    Line(points = {{168, -188}, {146, -188}, {146, -230}, {120, -230}}, color = {0, 0, 127}));
  connect(M_CW.y, sampler1.u) annotation(
    Line(points = {{96, 76}, {98, 76}, {98, -186}, {116, -186}}, color = {0, 0, 127}));
  connect(sampler1.y, CB_Run_index.u2) annotation(
    Line(points = {{139, -186}, {139, -238}, {120, -238}}, color = {0, 0, 127}));
  ...
  connect(realExpression1.y, P_Total.u2) annotation(
    Line(points = {{76, -146}, {84, -146}, {84, -162}, {50, -162}, {50, -182}, {58, -182}, {58, -180}}, color = {0, 0, 127}));
  annotation(
...
end Full_Cooling_Sys_Auto_high_seed_input;
