model Full_Cooling_Sys_Auto_low
  ...
  Modelica.Blocks.Noise.UniformNoise uniformNoise(fixedLocalSeed = 1, samplePeriod = 900, useAutomaticLocalSeed = false, useGlobalSeed = true, y_max = 0, y_min = -50, enableNoise = true) annotation(
...
equation
  ...
  connect(realExpression1.y, P_Total.u2) annotation(
    Line(points = {{76, -146}, {80, -146}, {80, -160}, {50, -160}, {50, -180}, {58, -180}}, color = {0, 0, 127}));
  annotation(
