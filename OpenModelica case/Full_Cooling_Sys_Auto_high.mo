model Full_Cooling_Sys_Auto_high
  ...
  Modelica.Blocks.Noise.UniformNoise uniformNoise(fixedLocalSeed = 4, samplePeriod = 900, useAutomaticLocalSeed = false, useGlobalSeed = true, y_max = 50, y_min = 0, enableNoise = true) annotation(
...
end Full_Cooling_Sys_Auto_high;
