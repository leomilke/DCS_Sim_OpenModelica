model Full_Cooling_Sys_origin
  ...
  Modelica.Blocks.Math.Gain gain(k = -1)  annotation(
    Placement(transformation(origin = {37, -33}, extent = {{5, -5}, {-5, 5}}, rotation = -0)));
  ...
  Modelica.Blocks.Math.Add P_C annotation(
    Placement(transformation(origin = {0, -140}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  Modelica.Blocks.Math.Product P_C_Real annotation(
    Placement(transformation(origin = {16, -174}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Sources.Step step(startTime = RunTime)  annotation(
    Placement(transformation(origin = {-70, -174}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Math.Add Bool_CSandCB_Run(k1 = -1)  annotation(
    Placement(transformation(origin = {-24, -202}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Sources.Constant const(k = 1)  annotation(
    Placement(transformation(origin = {-70, -206}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Math.Add P_Total(k2 = +1000)  annotation(
    Placement(transformation(origin = {60, -172}, extent = {{-10, -10}, {10, 10}})));
...
equation
  ...
  connect(TimeSeriesData.y[1], mflow_out_Tank.u2) annotation(
    Line(points = {{-38, -40}, {-10, -40}, {-10, -58}, {80, -58}, {80, -32}}, color = {0, 0, 127}));
  ...
  connect(P_CS.y, P_C.u2) annotation(
    Line(points = {{-44, -118}, {-6, -118}, {-6, -128}}, color = {0, 0, 127}));
  connect(P_CB.y, P_C.u1) annotation(
    Line(points = {{50, -118}, {6, -118}, {6, -128}}, color = {0, 0, 127}));
  connect(P_C.y, P_C_Real.u1) annotation(
    Line(points = {{0, -150}, {0, -168}, {4, -168}}, color = {0, 0, 127}));
  connect(step.y, Bool_CSandCB_Run.u1) annotation(
    Line(points = {{-58, -174}, {-46, -174}, {-46, -196}, {-36, -196}}, color = {0, 0, 127}));
  connect(Bool_CSandCB_Run.y, P_C_Real.u2) annotation(
    Line(points = {{-12, -202}, {4, -202}, {4, -180}}, color = {0, 0, 127}));
  connect(const.y, Bool_CSandCB_Run.u2) annotation(
    Line(points = {{-58, -206}, {-46, -206}, {-46, -208}, {-36, -208}}, color = {0, 0, 127}));
  connect(P_C_Real.y, P_Total.u1) annotation(
    Line(points = {{28, -174}, {32, -174}, {32, -166}, {48, -166}}, color = {0, 0, 127}));
  connect(TimeSeriesData.y[3], P_Total.u2) annotation(
    Line(points = {{-38, -40}, {-22, -40}, {-22, -74}, {28, -74}, {28, -146}, {40, -146}, {40, -178}, {48, -178}}, color = {0, 0, 127}));
  ...
  connect(m_flow_sum_CS_Real.u2, Bool_CSandCB_Run.y) annotation(
    Line(points = {{-64, 42}, {-74, 42}, {-74, -152}, {-10, -152}, {-10, -202}, {-12, -202}}, color = {0, 0, 127}));
