model Full_Cooling_Sys_Auto_fluc
  ...
  Modelica.Blocks.Noise.UniformNoise uniformNoise(fixedLocalSeed = 0, samplePeriod = 900, useAutomaticLocalSeed = false, useGlobalSeed = true, y_max = 50, y_min = -50, enableNoise = true) annotation(
...
end Full_Cooling_Sys_Auto_fluc;
