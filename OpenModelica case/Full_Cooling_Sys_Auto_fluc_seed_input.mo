model Full_Cooling_Sys_Auto_fluc_seed_input
  ...
  Modelica.Blocks.Noise.UniformNoise uniformNoise(fixedLocalSeed = Seed_Random_Py, samplePeriod = 900, useAutomaticLocalSeed = false, useGlobalSeed = true, y_max = 50, y_min = -50, enableNoise = true) annotation(
...
end Full_Cooling_Sys_Auto_fluc_seed_input;
